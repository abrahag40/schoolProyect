...
- **SPRINT 8 PROPUESTO — "Adopción ordenada de Metronic"** (cambio **C5**). Backlog en [docs/sprints/S8-metronic.md](docs/sprints/S8-metronic.md). El CEO tiene licencia **Extended** sin usar en otro proyecto; ADR-012 ejecuta el escape hatch que ADR-006 había previsto. **Empieza por el supuesto más riesgoso** —que nuestros tokens mapean sobre sus variables— con el componente más barato, antes del `DataGrid`. **El MVP pasa del Sprint 15 al 16** (cuarto corrimiento: C2, C3, C4, C5).
